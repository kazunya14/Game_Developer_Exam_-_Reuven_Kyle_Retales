...
namespace RK.Retales.Utility {
    ...
    [AddComponentMenu("_RKRetales/Utility/FPSCounter")]
    public class FPSCounter : MonoBehaviour {
        ...
        private float _framesDrawnInTheInterval;
        private Text _text;
        private float _timeLeft;
        private int _totalFrames;

        static FPSCounter() {
            StringsFrom00To300 = new[] {
        ...
        protected virtual void Update() {
            ...
            if(_currentFPS is < 0 or > 300) return;
            _text.text = $@"FPS: {mode switch {
                Modes.Instant => StringsFrom00To300[_currentFPS], 
                Modes.MovingAverage => StringsFrom00To300[_average], 
                Modes.InstantAndMovingAverage => StringsFrom00To300[_currentFPS] + " / " + StringsFrom00To300[_average], 
                _ => _text.text 
            }}";
        }

        private enum Modes { Instant, MovingAverage, InstantAndMovingAverage }
    }
}